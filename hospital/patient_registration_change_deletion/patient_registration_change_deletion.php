...
<html lang="ja"><!--ここからhtmlが始まるよ-->
  <head><!--このサイトの設定だよ-->
    ...
    <title>患者情報編集</title><!--サイトのバータイトルを　　　　　　　　　　　　入力！！！-->
    <!--<style>
    *{
      ...
      <footer><!--フッターだよ-->
        <section class="anything-top"><!--各ボタン-->
          <table>
            <tr>
              <td>
                <a href="../hospital_top.html"><button type="button" class="btn btn-outline-info">設定画面トップ</button></a>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-outline-info">患者情報アップロード<br>ダウンロード</button>
              </td>
            </tr>
          </table>
        </section>
